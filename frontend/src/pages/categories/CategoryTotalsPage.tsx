...
import { getCategoryTotals } from '../../api/categoryApi'
import LoadingSpinner from '../../components/shared/LoadingSpinner'
import type { CategoryTotalsResult } from '../../types/category'
...
/**
 * Totais por categoria: mesma apresentação que totais por pessoa (tabela + rodapé destacado).
 */
export default function CategoryTotalsPage() {
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState<string | null>(null)
  const [data, setData] = useState<CategoryTotalsResult | null>(null)
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold tracking-tight text-slate-900">Totais por categoria</h1>
      <p className="mt-1 text-sm text-slate-600">
        Receitas, despesas e saldo por categoria; rodapé com totais gerais.
      </p>
